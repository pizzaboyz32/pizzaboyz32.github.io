window.matchData = {
  ...
  veto: [
    ...
    { team: "t1", action: "pick", map: "Ascent", mapFile: "ascent.avif", note: "T1 Pick" },
    { team: "t2", action: "ban", map: "Haven", mapFile: "haven.avif" },
    { team: "t1", action: "ban", map: "Lotus", mapFile: "lotus.avif" },
    { team: null, action: "left", map: "Breeze", mapFile: "breeze.avif", note: "Decider" }
  ],
  maps: [
    {
      name: "Split",
